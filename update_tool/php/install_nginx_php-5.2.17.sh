...
wget https://www.centos.bz/wp-content/uploads/2012/06/debian_patches_disable_SSLv2_for_openssl_1_0_0.patch 
...
if [ $machine == "x86_64" ];then
      ...
      mv ./ZendOptimizer-3.3.9-linux-glibc23-x86_64/data/5_2_x_comp/ZendOptimizer.so  /alidata/server/php/lib/php/extensions/no-debug-non-zts-20090626/
else
	  ...
	  mv ./ZendOptimizer-3.3.9-linux-glibc23-i386/data/5_2_x_comp/ZendOptimizer.so /alidata/server/php/lib/php/extensions/no-debug-non-zts-20100525/
fi
...
echo "zend_extension=/alidata/server/php/lib/php/extensions/no-debug-non-zts-20090626/ZendOptimizer.so" >> /alidata/server/php/etc/php.ini